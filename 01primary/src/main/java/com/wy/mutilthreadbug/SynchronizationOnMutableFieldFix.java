...
/**
 * Created by yunwang on 2021/6/30 16:32
 */
public class SynchronizationOnMutableFieldFix {
    ...
    public static void main(String[] args) throws Exception {
        SynchronizationOnMutableFieldFix demo = new SynchronizationOnMutableFieldFix();
